...
Este é um projeto full-stack com arquitetura API RESTful no backend, desenvolvido em **Kotlin** com o framework **Spring Boot**, e um front-end moderno criado em **React**.  
